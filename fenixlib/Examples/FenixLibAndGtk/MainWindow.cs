...
namespace FenixLibAndGtkExample
{
    public partial class MainWindow : Gtk.Window
    {
        ...
        private ISpriteAssortment spriteAssortment = null;
        ...
        void UpdateViewWithSpriteAssortment(ISpriteAssortment spriteAssortment)
        {
            ...
            foreach (var sprite in this.spriteAssortment)
            {
        ...
        protected void OnOpenFpgClicked(object sender, EventArgs e)
        {
            ...
            {
                spriteAssortment = NativeFile.LoadFpg(openDialog.Filename);
                UpdateViewWithSpriteAssortment(spriteAssortment);
            }
